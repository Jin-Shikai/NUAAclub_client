...
public class homeFragment extends BaseFragment {
    ...
    protected View initView() {
        ...
        newEassy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //2. 创建post请求
                String url = "http://"+getResources().getString(R.string.address)+":8080/LoginDemo/newEssayServlet";
    ...
    protected void initData() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(mContext);
        //2. 创建get请求
        String url = "http://"+getResources().getString(R.string.address)+":8080/LoginDemo/requestListServlet";
